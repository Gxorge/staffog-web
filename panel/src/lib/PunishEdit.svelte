    ...
    {:else}
        ...
        <section class="section">
            <form method="post">
                ...
                <div class="field">
                    <label class="label">
                        Please enter the new reason for {entry.name}'s {type.toLowerCase()}
                        <br>
                        <div class="control">
                            <input name="reason" class="input " type="text" placeholder="New {type.toLowerCase()} reason">
                        </div>
                    </label>
                </div>

                <div class="buttons control">
                    <button class="button is-link">Edit {type}</button>
                    <a class="button" href={"/" + type.toLowerCase() + "s/" + entry.id}>Back</a>
                </div>
            </form>  
        </section>    
